...
const Bar = () => {
    return (
        <>
            <Container maxWidth="lg" style={{marginTop:"10px", background:"#eee"}}>
                <Grid container spacing={3}>
                    <Grid item xs={12} md={12}>
                        <Typography variant="h4" style={{marginTop: "20px", fontWeight:"200"}} gutterBottom align="center">Property is our Business</Typography>
